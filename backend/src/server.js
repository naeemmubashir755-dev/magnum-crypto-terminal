...
const trendingCoinsRoutes = require('./routes/trendingCoinsRoutes');
const globalMarketRoutes = require('./routes/globalMarketRoutes');
...
app.use('/api', trendingCoinsRoutes);
app.use('/api', globalMarketRoutes);
